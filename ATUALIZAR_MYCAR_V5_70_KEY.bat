...
chcp 65001 >nul
title Atualizacao MyCar+ V5.70 KEY

set "VERSAO=5.70"
set "ZIP_PREFIX=MYCAR_PLUS_V5_70_KEY"
set "PASTA_INTERNA=MYCAR_PLUS_V5_70_KEY"
set "PROJETO=%USERPROFILE%\Documents\GitHub\MyCarPlus"
set "DOWNLOADS=%USERPROFILE%\Downloads"
set "WORKTEMP=%DOWNLOADS%\MYCAR_PLUS_V5_70_KEY_TEMP"
set "LOG=%DOWNLOADS%\ATUALIZACAO_MYCAR_V5_70_KEY_LOG.txt"
set "APK_DESTINO=%DOWNLOADS%\MYCAR_PLUS_V5_70_KEY_DEBUG.apk"
set "STUDIO=C:\Program Files\Android\Android Studio\bin\studio64.exe"

> "%LOG%" echo ============================================================
>>"%LOG%" echo ATUALIZACAO MYCAR+ V5.70 KEY
...
echo.
echo ============================================================
echo ATUALIZACAO MYCAR+ V5.70 KEY
echo ============================================================
...
if not defined ZIP (
    echo [ERRO] ZIP V5.70 KEY nao encontrado em Downloads.
...
if errorlevel 1 (
    git commit -m "Atualiza MyCar+ para V5.70 KEY" >>"%LOG%" 2>&1
...
echo.
echo ============================================================
echo ATUALIZACAO V5.70 KEY CONCLUIDA COM SUCESSO

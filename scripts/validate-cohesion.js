...
const batch = read('ATUALIZAR_MYCAR_V5_58_WEB_ANDROID.bat');
...
// BAT.
assert(batch.includes('set "VERSAO=5.58"'), 'BAT não está configurado para 5.58.');
assert(batch.includes('MYCAR_PLUS_V5_58_MASTER.zip'), 'BAT não procura o ZIP V5.58.');
...
const syncedFiles = [
  ...
  'icon-32.png','icon-180.png','icon-192.png','icon-512.png','desenvolvedor.png',
  'data/MyCarPlus.xlsx',
];

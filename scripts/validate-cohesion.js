...
const batch = read('ATUALIZAR_MYCAR_V5_63_WEB_ANDROID.bat');
...
// BAT.
assert(batch.includes('set "VERSAO=5.63"'), 'BAT não está configurado para 5.63.');
assert(batch.includes('MYCAR_PLUS_V5_63_MASTER.zip'), 'BAT não procura o ZIP V5.63.');

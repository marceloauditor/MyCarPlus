...
window.addEventListener("message", (event) => {
  ...
  if (data.type === "mycar-print-report-html") {
    ...
    if (!html.trim()) return;
    const bridge = window.MyCarNative;
    if (isNativeApp() && bridge && typeof bridge.printHtml === "function") {
...
function exportPdfReport() {
  ...
  function printHtml(){var html=printable();try{if(window.parent&&window.parent!==window){window.parent.postMessage({type:'mycar-print-report-html',jobName:'RELATORIO_EXECUTIVO_MYCAR_PLUS',html:html},'*');return}}catch(e){}window.print()}function shareHtml(){
    try{

...
Na pasta Downloads, mantenha o arquivo `MYCAR_PLUS_V5_71_KEY.zip` e execute:

```powershell
.\ATUALIZAR_MYCAR_V5_71_KEY.bat
```

O BAT cria backup, instala dependências, sincroniza Web e Android, valida a coesão e gera o APK de teste.

Se o navegador salvar o ZIP com sufixo como `(1)`, o BAT V5.71 localiza automaticamente o arquivo mais recente compatível na pasta Downloads.

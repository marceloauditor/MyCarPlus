...
chcp 65001 >nul
title Atualizacao MyCar+ V6.05 KEY

set "VERSAO=6.05"
set "ZIP_PREFIX=MYCAR_PLUS_V6_05_KEY"
set "ZIP_ESPERADO=MYCAR_PLUS_V6_05_KEY.zip"
set "PASTA_INTERNA=MYCAR_PLUS_V6_05_KEY"
set "PROJETO=%USERPROFILE%\Documents\GitHub\MyCarPlus"
set "DOWNLOADS=%USERPROFILE%\Downloads"
set "WORKTEMP=%DOWNLOADS%\MYCAR_PLUS_V6_05_KEY_TEMP"
set "LOG=%DOWNLOADS%\ATUALIZACAO_MYCAR_V6_05_KEY_LOG.txt"
set "APK_DESTINO=%DOWNLOADS%\MYCAR_PLUS_V6_05_KEY_DEBUG.apk"
set "STUDIO=C:\Program Files\Android\Android Studio\bin\studio64.exe"

> "%LOG%" echo ============================================================
>>"%LOG%" echo ATUALIZACAO MYCAR+ V6.05 KEY
...
echo.
echo ============================================================
echo ATUALIZACAO MYCAR+ V6.05 KEY
echo ============================================================

set "ZIP=%DOWNLOADS%\%ZIP_ESPERADO%"
if not exist "%ZIP%" set "ZIP="
if not defined ZIP (
...
set "STAMP=%STAMP: =0%"
set "BACKUP=%USERPROFILE%\Documents\GitHub\MyCarPlus_BACKUP_ANTES_V6_05_%STAMP%"
...
findstr /C:"APP_VERSION = ""6.05""" "%PROJETO%\app.js" >nul || goto :erro_versao
findstr /C:"APP_VERSION = ""6.05""" "%PROJETO%\www\app.js" >nul || goto :erro_versao
findstr /C:"APP_VERSION = ""6.05""" "%PROJETO%\android\app\src\main\assets\public\app.js" >nul || goto :erro_versao
findstr /C:"mycar-plus-v6-05" "%PROJETO%\sw.js" >nul || goto :erro_versao
findstr /C:"mycar-plus-v6-05" "%PROJETO%\www\sw.js" >nul || goto :erro_versao
findstr /C:"mycar-plus-v6-05" "%PROJETO%\android\app\src\main\assets\public\sw.js" >nul || goto :erro_versao
echo [OK] Versao 6.05 confirmada na fonte, Web e Android.
>>"%LOG%" echo [OK] Versao 6.05 confirmada nas tres camadas.
...
if errorlevel 1 (
    git commit -m "Atualiza MyCar+ para V6.05 KEY" >>"%LOG%" 2>&1
...
findstr /C:"versionCode 605" "%PROJETO%\android\app\build.gradle" >nul || goto :erro_versao
findstr /C:"versionName ""6.05.0""" "%PROJETO%\android\app\build.gradle" >nul || goto :erro_versao
...
echo.
echo ============================================================
echo ATUALIZACAO V6.05 KEY CONCLUIDA COM SUCESSO
...
goto :fim_erro
:erro_versao
echo [ERRO] A versao 6.05 nao foi confirmada em todas as camadas.

...
chcp 65001 >nul
title Atualizacao MyCar+ V5.95 KEY

set "VERSAO=5.95"
set "ZIP_PREFIX=MYCAR_PLUS_V5_95_KEY"
set "ZIP_ESPERADO=MYCAR_PLUS_V5_95_KEY.zip"
set "PASTA_INTERNA=MYCAR_PLUS_V5_95_KEY"
set "PROJETO=%USERPROFILE%\Documents\GitHub\MyCarPlus"
set "DOWNLOADS=%USERPROFILE%\Downloads"
set "WORKTEMP=%DOWNLOADS%\MYCAR_PLUS_V5_95_KEY_TEMP"
set "LOG=%DOWNLOADS%\ATUALIZACAO_MYCAR_V5_95_KEY_LOG.txt"
set "APK_DESTINO=%DOWNLOADS%\MYCAR_PLUS_V5_95_KEY_DEBUG.apk"
set "STUDIO=C:\Program Files\Android\Android Studio\bin\studio64.exe"

> "%LOG%" echo ============================================================
>>"%LOG%" echo ATUALIZACAO MYCAR+ V5.95 KEY
...
echo.
echo ============================================================
echo ATUALIZACAO MYCAR+ V5.95 KEY
echo ============================================================
...
set "STAMP=%STAMP: =0%"
set "BACKUP=%USERPROFILE%\Documents\GitHub\MyCarPlus_BACKUP_ANTES_V5_95_%STAMP%"
...
for /d /r "%PROJETO%\android\app\src\main\java" %%D in (
    ...
    MYCAR_PLUS_V5_93_TEMP
    MYCAR_PLUS_V5_94_TEMP
    MYCAR_PLUS_V5_95_TEMP
    ...
    MYCAR_PLUS_V5_93_MASTER
    MYCAR_PLUS_V5_94_MASTER
    MYCAR_PLUS_V5_95_MASTER
    ...
    MYCAR_PLUS_V5_93_TREE
    MYCAR_PLUS_V5_94_TREE
    MYCAR_PLUS_V5_95_TREE
    ...
    MYCAR_PLUS_V5_93_KEY
    MYCAR_PLUS_V5_94_KEY
    MYCAR_PLUS_V5_95_KEY
) do (
...
if errorlevel 1 (
    git commit -m "Atualiza MyCar+ para V5.95 KEY" >>"%LOG%" 2>&1
...
echo.
echo ============================================================
echo ATUALIZACAO V5.95 KEY CONCLUIDA COM SUCESSO

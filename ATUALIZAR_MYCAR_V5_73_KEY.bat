...
chcp 65001 >nul
title Atualizacao MyCar+ V5.73 KEY

set "VERSAO=5.73"
set "ZIP_PREFIX=MYCAR_PLUS_V5_73_KEY"
set "ZIP_ESPERADO=MYCAR_PLUS_V5_73_KEY.zip"
set "PASTA_INTERNA=MYCAR_PLUS_V5_73_KEY"
set "PROJETO=%USERPROFILE%\Documents\GitHub\MyCarPlus"
set "DOWNLOADS=%USERPROFILE%\Downloads"
set "WORKTEMP=%DOWNLOADS%\MYCAR_PLUS_V5_73_KEY_TEMP"
set "LOG=%DOWNLOADS%\ATUALIZACAO_MYCAR_V5_73_KEY_LOG.txt"
set "APK_DESTINO=%DOWNLOADS%\MYCAR_PLUS_V5_73_KEY_DEBUG.apk"
set "STUDIO=C:\Program Files\Android\Android Studio\bin\studio64.exe"

> "%LOG%" echo ============================================================
>>"%LOG%" echo ATUALIZACAO MYCAR+ V5.73 KEY
...
echo.
echo ============================================================
echo ATUALIZACAO MYCAR+ V5.73 KEY
echo ============================================================
...
set "STAMP=%STAMP: =0%"
set "BACKUP=%USERPROFILE%\Documents\GitHub\MyCarPlus_BACKUP_ANTES_V5_73_%STAMP%"
...
if errorlevel 1 (
    git commit -m "Atualiza MyCar+ para V5.73 KEY" >>"%LOG%" 2>&1
...
echo.
echo ============================================================
echo ATUALIZACAO V5.73 KEY CONCLUIDA COM SUCESSO

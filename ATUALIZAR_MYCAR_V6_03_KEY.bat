...
chcp 65001 >nul
title Atualizacao MyCar+ V6.03 KEY

set "VERSAO=6.03"
set "ZIP_PREFIX=MYCAR_PLUS_V6_03_KEY"
set "ZIP_ESPERADO=MYCAR_PLUS_V6_03_KEY.zip"
set "PASTA_INTERNA=MYCAR_PLUS_V6_03_KEY"
set "PROJETO=%USERPROFILE%\Documents\GitHub\MyCarPlus"
set "DOWNLOADS=%USERPROFILE%\Downloads"
set "WORKTEMP=%DOWNLOADS%\MYCAR_PLUS_V6_03_KEY_TEMP"
set "LOG=%DOWNLOADS%\ATUALIZACAO_MYCAR_V6_03_KEY_LOG.txt"
set "APK_DESTINO=%DOWNLOADS%\MYCAR_PLUS_V6_03_KEY_DEBUG.apk"
set "STUDIO=C:\Program Files\Android\Android Studio\bin\studio64.exe"

> "%LOG%" echo ============================================================
>>"%LOG%" echo ATUALIZACAO MYCAR+ V6.03 KEY
...
echo.
echo ============================================================
echo ATUALIZACAO MYCAR+ V6.03 KEY
echo ============================================================
...
set "STAMP=%STAMP: =0%"
set "BACKUP=%USERPROFILE%\Documents\GitHub\MyCarPlus_BACKUP_ANTES_V6_03_%STAMP%"
...
findstr /C:"APP_VERSION = ""6.03""" "%PROJETO%\app.js" >nul || goto :erro_versao
findstr /C:"APP_VERSION = ""6.03""" "%PROJETO%\www\app.js" >nul || goto :erro_versao
findstr /C:"APP_VERSION = ""6.03""" "%PROJETO%\android\app\src\main\assets\public\app.js" >nul || goto :erro_versao
findstr /C:"mycar-plus-v6-03" "%PROJETO%\www\sw.js" >nul || goto :erro_versao
echo [OK] Versao 6.03 confirmada na fonte, Web e Android.
>>"%LOG%" echo [OK] Versao 6.03 confirmada nas tres camadas.
...
if errorlevel 1 (
    git commit -m "Atualiza MyCar+ para V6.03 KEY" >>"%LOG%" 2>&1
...
findstr /C:"versionCode 603" "%PROJETO%\android\app\build.gradle" >nul || goto :erro_versao
findstr /C:"versionName ""6.03.0""" "%PROJETO%\android\app\build.gradle" >nul || goto :erro_versao
...
echo.
echo ============================================================
echo ATUALIZACAO V6.03 KEY CONCLUIDA COM SUCESSO
...
goto :fim_erro
:erro_versao
echo [ERRO] A versao 6.03 nao foi confirmada em todas as camadas.

...
chcp 65001 >nul
title Atualizacao MyCar+ V6.08 KEY

set "VERSAO=6.08"
set "VERSAO_SEM_PONTO=608"
set "ZIP_PREFIX=MYCAR_PLUS_V6_08_KEY"
set "ZIP_ESPERADO=MYCAR_PLUS_V6_08_KEY.zip"
set "PASTA_INTERNA=MYCAR_PLUS_V6_08_KEY"
set "PROJETO=%USERPROFILE%\Documents\GitHub\MyCarPlus"
set "DOWNLOADS=%USERPROFILE%\Downloads"
set "WORKTEMP=%DOWNLOADS%\MYCAR_PLUS_V6_08_KEY_TEMP"
set "LOG=%DOWNLOADS%\ATUALIZACAO_MYCAR_V6_08_KEY_LOG.txt"
set "DIAGNOSTICO=%DOWNLOADS%\DIAGNOSTICO_MYCAR_V6_08.txt"
set "APK_DESTINO=%DOWNLOADS%\MYCAR_PLUS_V6_08_KEY_DEBUG.apk"
...
>"%LOG%" echo ============================================================
>>"%LOG%" echo ATUALIZACAO MYCAR+ V6.08 KEY - ANALISE INTELIGENTE COMPLETA E DICA LEGIVEL
...
>"%DIAGNOSTICO%" echo ============================================================
>>"%DIAGNOSTICO%" echo DIAGNOSTICO MYCAR+ V6.08
>>"%DIAGNOSTICO%" echo Inicio: %DATE% %TIME%
>>"%DIAGNOSTICO%" echo ============================================================

echo.
echo ============================================================
echo ATUALIZACAO MYCAR+ V6.08 KEY - ANALISE INTELIGENTE COMPLETA E DICA LEGIVEL
echo ============================================================
...
set "STAMP=%STAMP: =0%"
set "BACKUP=%USERPROFILE%\Documents\GitHub\MyCarPlus_BACKUP_ANTES_V6_08_%STAMP%"
...
if exist "%PROJETO%\ATUALIZAR_MYCAR_V6_07_KEY.bat" (
  set "MOTIVO=Limpeza controlada nao removeu ATUALIZAR_MYCAR_V6_07_KEY.bat"
  goto :fim_erro
)
if exist "%PROJETO%\VALIDACAO_PACOTE_V6_07_KEY.txt" (
  set "MOTIVO=Limpeza controlada nao removeu VALIDACAO_PACOTE_V6_07_KEY.txt"
  goto :fim_erro
)
if exist "%PROJETO%\MANIFEST_SHA256_V6_07.txt" (
  set "MOTIVO=Limpeza controlada nao removeu MANIFEST_SHA256_V6_07.txt"
  goto :fim_erro
)
echo [OK] Limpeza controlada concluida.

echo.
echo [5/12] Copiando a V6.08 para o projeto...
...
robocopy "%FONTE%" "%PROJETO%" /E /R:2 /W:2 ^
 ...
 /XF "local.properties" "*_LOG.txt" >>"%LOG%"
if errorlevel 8 (
  set "MOTIVO=Falha ao copiar a fonte V6.08"
  goto :fim_erro
)
...
git commit -m "Atualiza MyCar+ para V6.08 - analise inteligente completa e dica legivel" >>"%LOG%" 2>&1
if errorlevel 1 (
...
>>"%DIAGNOSTICO%" echo [RESULTADO][OK] Atualizacao V6.08 concluida.
echo.
echo ============================================================
echo ATUALIZACAO V6.08 CONCLUIDA COM SUCESSO

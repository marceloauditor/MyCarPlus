...
chcp 65001 >nul
title Atualizacao MyCar+ V5.98 KEY

set "VERSAO=5.98"
set "ZIP_PREFIX=MYCAR_PLUS_V5_98_KEY"
set "ZIP_ESPERADO=MYCAR_PLUS_V5_98_KEY.zip"
set "PASTA_INTERNA=MYCAR_PLUS_V5_98_KEY"
set "PROJETO=%USERPROFILE%\Documents\GitHub\MyCarPlus"
set "DOWNLOADS=%USERPROFILE%\Downloads"
set "WORKTEMP=%DOWNLOADS%\MYCAR_PLUS_V5_98_KEY_TEMP"
set "LOG=%DOWNLOADS%\ATUALIZACAO_MYCAR_V5_98_KEY_LOG.txt"
set "APK_DESTINO=%DOWNLOADS%\MYCAR_PLUS_V5_98_KEY_DEBUG.apk"
set "STUDIO=C:\Program Files\Android\Android Studio\bin\studio64.exe"

> "%LOG%" echo ============================================================
>>"%LOG%" echo ATUALIZACAO MYCAR+ V5.98 KEY
...
echo.
echo ============================================================
echo ATUALIZACAO MYCAR+ V5.98 KEY
echo ============================================================
...
set "STAMP=%STAMP: =0%"
set "BACKUP=%USERPROFILE%\Documents\GitHub\MyCarPlus_BACKUP_ANTES_V5_98_%STAMP%"
...
findstr /C:"APP_VERSION = ""5.98""" "%PROJETO%\app.js" >nul || goto :erro_versao
findstr /C:"APP_VERSION = ""5.98""" "%PROJETO%\www\app.js" >nul || goto :erro_versao
findstr /C:"APP_VERSION = ""5.98""" "%PROJETO%\android\app\src\main\assets\public\app.js" >nul || goto :erro_versao
findstr /C:"mycar-plus-v5-98" "%PROJETO%\www\sw.js" >nul || goto :erro_versao
echo [OK] Versao 5.98 confirmada na fonte, Web e Android.
>>"%LOG%" echo [OK] Versao 5.98 confirmada nas tres camadas.
...
if errorlevel 1 (
    git commit -m "Atualiza MyCar+ para V5.98 KEY" >>"%LOG%" 2>&1
...
findstr /C:"versionCode 598" "%PROJETO%\android\app\build.gradle" >nul || goto :erro_versao
findstr /C:"versionName ""5.98.0""" "%PROJETO%\android\app\build.gradle" >nul || goto :erro_versao
...
echo.
echo ============================================================
echo ATUALIZACAO V5.98 KEY CONCLUIDA COM SUCESSO
...
goto :fim_erro
:erro_versao
echo [ERRO] A versao 5.98 nao foi confirmada em todas as camadas.
